...
def scrape_mensa():
    ...
    for date in dates:
        ...
        ausgaben = ['ausgabe-eins', 'ausgabe-zwei', 'ausgabe-drei', 'suppe', 'beilagen', 'salate', 'desserts', 'culinarium-hauptgerichte', 'culinarium-beilagen', 'culinarium-desserts', 'culinarium-salate']
...
#ressource to get data from current day, return empty json if not exists
...
#ressource to get data from specific day, return empty json if not exists
